<?php /* Smarty version 2.6.19, created on 2014-09-02 16:24:43
         compiled from senddate.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'senddate.tpl', 45, false),array('function', 'add_script', 'senddate.tpl', 84, false),array('modifier', 'date_format', 'senddate.tpl', 51, false),)), $this); ?>
...
" id="tr_<?php echo $this->_tpl_vars['item']['config_id']; ?>
">
				    				<td align="center" ><input type='checkbox' class="border0" id="<?php echo $this->_tpl_vars['item']['config_id']; ?>
" value='<?php echo $this->_tpl_vars['item']['config_id']; ?>
'></td>
				    				<td align="center" class="font12"><?php echo $this->_tpl_vars['loopH']; ?>
</td>
				    				<td align="center" class="font12" ><?php echo $this->_tpl_vars['item']['config_level']; ?>
</td>
				    				<td align="center" class="font12"><?php echo $this->_tpl_vars['item']['config_senddate']; ?>
</td>
				    				<td align="left" class="font12"><?php echo $this->_tpl_vars['item']['config_desc']; ?>
</td>
				    				...
				    				<td align="center" class="font12" id="txt_link_user" nowrap>
				    					<input id="btn_edit" title="Edit" class="btn_tools" onclick="openSendDate('edit','<?php echo $this->_tpl_vars['item']['config_id']; ?>
