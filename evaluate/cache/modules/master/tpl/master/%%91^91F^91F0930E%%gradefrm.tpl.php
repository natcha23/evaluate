<?php /* Smarty version 2.6.19, created on 2014-09-09 13:09:11
         compiled from gradefrm.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'add_script', 'gradefrm.tpl', 97, false),)), $this); ?>
			          ...
			          <tr>
				    	<td colspan="2" align="center">
				    		<table bgcolor="#ffffff" cellpadding="0" cellspacing="1" width="100%" border="0" style="border:1px solid #B9B9B9;">
				    			<tr bgcolor="#EBEBEB">
									<td align="right" >
											<?php if ($this->_tpl_vars['mode'] != 'view'): ?><input id="btn_save" title="Save" class="btn_tools" onclick="chekSubmit();" value=" Save " type="button"><?php endif; ?>
...
">
										<input type="hidden" name="grade_old" value="<?php echo $this->_tpl_vars['rows']['grade']; ?>
" >
									...
									<td align="center" >
										<table bgcolor="#ffffff" cellpadding="0" cellspacing="1" width="100%" border="0" >
									    	<tr>
										    	...
										    	<td class="font12"><input type="text" name="fields[grade]" id="grade" value="<?php echo $this->_tpl_vars['rows']['grade']; ?>
" class="textfield_3c" maxLength="3"></td>
									    	</tr>
									    	<tr>
										    	<td width="2%">&nbsp;</td>
										    	<td align="left" width="15%" class="font11b">คะแนนเริ่มต้น</td>
										    	<td class="font12"><input type="text" name="fields[start_scoll]" id="start_scoll" value="<?php echo $this->_tpl_vars['rows']['start_scoll']; ?>
" class="textfield_3c" onKeyup="ckvNum(this);"></td>
									    	</tr>
									    	<tr>
										    	<td width="2%">&nbsp;</td>
										    	<td align="left" width="15%" class="font11b">คะแนนสิ้นสุด</td>
										    	<td class="font12"><input type="text" name="fields[end_scoll]" id="end_scoll" value="<?php echo $this->_tpl_vars['rows']['end_scoll']; ?>
" class="textfield_3c" onKeyup="ckvNum(this);"></td>
									    	</tr>
									    	<tr>
										    	<td width="2%">&nbsp;</td>
										    	<td align="left" width="15%" class="font11b">หมายเหตุ</td>
										    	<td class="font12"><textarea name="fields[gr_desc]" id="gr_desc" rows="5" class="textfield_10c"><?php echo $this->_tpl_vars['rows']['gr_desc']; ?>
</textarea></td>
									    	</tr>
