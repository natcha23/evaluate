<?php /* Smarty version 2.6.19, created on 2014-08-28 15:03:54
         compiled from typemst.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'typemst.tpl', 45, false),array('function', 'add_script', 'typemst.tpl', 84, false),array('modifier', 'date_format', 'typemst.tpl', 51, false),)), $this); ?>
				    		...
				    		<table bgcolor="#ffffff" cellpadding="0" cellspacing="1" width="100%" border="0" style="border:1px solid #B9B9B9;">
				    			<tr height="25" >
					    			<td colspan="4" align="left" >
					    				<input id="btn_new" title=" Create New" class="btn_tools" onclick="openPageType('new','','<?php echo $this->_tpl_vars['mId']; ?>
...
" id="tr_<?php echo $this->_tpl_vars['item']['type_id']; ?>
">
				    				<td align="center" ><input type='checkbox' class="border0" id="<?php echo $this->_tpl_vars['item']['type_id']; ?>
" value='<?php echo $this->_tpl_vars['item']['type_id']; ?>
'></td>
				    				<td align="center" class="font12"><?php echo $this->_tpl_vars['loopH']; ?>
</td>
				    				<td align="center" class="font12" ><?php echo $this->_tpl_vars['item']['type_name']; ?>
</td>
				    				<td align="left" class="font12">&nbsp;<?php echo $this->_tpl_vars['item']['type_fullname']; ?>
</td>
				    				<td align="left" class="font12">&nbsp;<?php echo $this->_tpl_vars['item']['type_desc']; ?>
</td>
				    				...
				    				<td align="center" class="font12" id="txt_link_user">
				    					<input id="btn_edit" title="Edit" class="btn_tools" onclick="openPageType('edit','<?php echo $this->_tpl_vars['item']['type_id']; ?>
